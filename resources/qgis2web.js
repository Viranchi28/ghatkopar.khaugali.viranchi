...
map.getView().fit([72.903209, 19.079109, 72.908008, 19.081238], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Ghatkopar Khaugali</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (25 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Ar. Viranchi Sinha<br /><br />KRVIA';
            }
